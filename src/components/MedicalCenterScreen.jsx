...
export default function MedicalCenterScreen({ game, onOpenPlayer }) {
  ...
  return <div style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden"}}>
    ...
    })}</div>:<div style={{ background:"#161a24", borderRadius:9, padding:18, textAlign:"center", color:"#6b7280", fontSize:11, marginBottom:18 }}>🟢 Todos los jugadores están disponibles.</div>}{patients.some(item=>item.player.medical?.remainingDays>0)&&<div style={{ color:"#4b5563", fontSize:9, lineHeight:1.5, marginTop:15 }}>Los plazos son estimados. La recuperación avanza con cada jornada: lesión, recuperación, apto con limitaciones y alta médica.</div>}</>}
