...
const statusMap={
  ...
  withdrawn:["↩️","Retirada",COLORS.textDim],
};
...
export default function ContractsScreen({game,onOpenPlayer,onCreateRenewal,onAcceptCounter,onComplete,onWithdraw}){
  ...
  return <div style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden"}}>
    ...
    <div style={{flex:1,overflowY:"auto",padding:12}}>
      ...
      {!shown.length&&<div style={{textAlign:"center",color:COLORS.textDim,padding:30,fontSize:12}}>No hay contratos en esta vista.</div>}
    </div>
