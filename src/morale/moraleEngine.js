import { getAssistantSquadManagementMultiplier } from "../staff/staffEngine.js";
...
export const PLAYER_PERSONALITY_PROFILES = {
  ...
  competitive: { id:"competitive", label:"Competitivo", tone:"intenso", frequency:1.1, minutesSensitivity:1.12, trainingResponse:1.08, negotiation:"reto_deportivo", line:"Dame un reto y voy a responder." },
...
export function personalityLine(player, situation = "general") {
  ...
  const specific = {
    minutes: {
      ...
      reserved: "Confío en ti, pero quería entender mi situación.",
      ...
      insecureYoung: "No sé si estoy haciendo algo mal. Quería preguntártelo.",
...
export function updatePlayerHumanState(player, game, context = {}) {
  ...
  // Fórmula centralizada en getAssistantSquadManagementMultiplier (staffEngine.js).
  const squadManagementMod = getAssistantSquadManagementMultiplier(game);
