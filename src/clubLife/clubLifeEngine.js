...
export const CLUB_LIFE_ACTORS = {
  sportingDirector: {
    ...
    speakingStyle: "analÃ­tico y prudente",
    priorities: ["contratos", "mercado", "planificaciÃ³n"],
    insistence: 62,
    frequency: "media",
  },
  assistantCoach: {
    ...
    emoji: "ðŸ‘¥",
    color: "#c9a84c",
    personality: "directo y prÃ¡ctico",
    speakingStyle: "breve y claro",
    priorities: ["alineaciÃ³n", "rival", "tÃ¡ctica"],
    insistence: 58,
    frequency: "alta",
  },
  doctor: {
    ...
    priorities: ["lesiones", "recuperaciÃ³n", "riesgo fÃ­sico"],
    insistence: 74,
    frequency: "media",
  },
  fitnessCoach: {
    ...
    speakingStyle: "prÃ¡ctico y preocupado",
  ...
  psychologist: {
    ...
    speakingStyle: "calmado y empÃ¡tico",
  ...
  president: {
    ...
    priorities: ["objetivos", "economÃ­a", "prestigio"],
    insistence: 78,
    frequency: "baja",
  },
  academyChief: {
    ...
    priorities: ["jÃ³venes", "promociÃ³n", "desarrollo"],
    insistence: 48,
    frequency: "media",
  },
  pressOfficer: {
    ...
    priorities: ["prensa", "aficiÃ³n", "imagen"],
    insistence: 64,
    frequency: "media",
  },
};
...
function observeNeeds(game, context = {}) {
  ...
  if (fixture && lineupCount < 11) {
    needs.push(issue(game, {
      ...
      priority: "urgent",
      title: "El once no estÃ¡ preparado",
      message: "MÃ­ster, todavÃ­a no hemos preparado el once para el prÃ³ximo partido.",
      emotionalState: "directo",
      actionRequired: "Completar alineaciÃ³n antes de jugar.",
  ...
  if (expiring) {
    needs.push(issue(game, {
      ...
      actionRequired: "Decidir si se abre una renovaciÃ³n.",
      consequenceIfIgnored: "El jugador puede perder confianza o escuchar propuestas externas.",
      expectedOutcome: "SituaciÃ³n contractual definida.",
  ...
  if (risky) {
    needs.push(issue(game, {
      ...
      message: `${risky.player.name} estÃ¡ acumulando seÃ±ales de riesgo. Yo no lo forzarÃ­a.`,
      emotionalState: "preocupado",
      actionRequired: "Revisar carga, entrenamiento o alineaciÃ³n.",
      consequenceIfIgnored: "Aumenta el riesgo de lesiÃ³n y bajada de rendimiento.",
      expectedOutcome: "Riesgo fÃ­sico reducido.",
  ...
  if (locker.atmosphere === "tenso" || locker.unhappy.length >= 2) {
    needs.push(issue(game, {
      ...
      title: "El vestuario necesita una seÃ±al",
  ...
  if (incomingOffer) {
    needs.push(issue(game, {
      ...
      message: `Ha llegado una oferta por ${incomingOffer.playerName}. Necesitamos decidir antes de que se enfrÃ­e.`,
      emotionalState: "expectante",
      actionRequired: "Aceptar, rechazar o negociar la oferta.",
      consequenceIfIgnored: "La operaciÃ³n puede caducar y afectar a la planificaciÃ³n.",
  ...
  if (last && last.matchday === (game.matchday ?? 1) - 1 && result?.lost && result.margin >= 2) {
    needs.push(issue(game, {
      ...
      priority: "important",
      title: "La prensa espera una explicaciÃ³n",
      message: "La sala de prensa estÃ¡ pendiente de tu reacciÃ³n. Conviene controlar el mensaje.",
      emotionalState: "tenso",
      actionRequired: "Responder pÃºblicamente o proteger al grupo.",
      consequenceIfIgnored: "La presiÃ³n externa puede aumentar sobre jugadores y entrenador.",
      expectedOutcome: "Mensaje pÃºblico definido.",
      action: { screen: "news" },
  ...
  if (fanSupport < 42) {
    needs.push(issue(game, {
      ...
      actorId: "president",
      priority: "important",
      title: "La aficiÃ³n estÃ¡ perdiendo confianza",
      message: "La grada estÃ¡ empezando a dudar. Necesitamos una reacciÃ³n deportiva o un mensaje claro.",
      emotionalState: "exigente",
      actionRequired: "Revisar objetivos, discurso o rendimiento.",
      consequenceIfIgnored: "BajarÃ¡ la confianza institucional y aumentarÃ¡ la presiÃ³n.",
      expectedOutcome: "AficiÃ³n contenida.",
      action: { screen: "fans" },
      actionLabel: "Escuchar aficiÃ³n",
    }));
  }
  ...
  if (prospect && (prospect.potential ?? 0) >= 86 && (game.players ?? []).length < 30) {
    needs.push(issue(game, {
      ...
      priority: "normal",
      title: `${prospect.name} estÃ¡ llamando a la puerta`,
      message: `${prospect.name} estÃ¡ creciendo rÃ¡pido. Creo que merece que lo mires con calma.`,
      emotionalState: "ilusionado",
      actionRequired: "Valorar promociÃ³n o plan de desarrollo.",
      consequenceIfIgnored: "El jugador puede estancarse o perder una oportunidad de integraciÃ³n.",
      expectedOutcome: "DecisiÃ³n sobre su desarrollo.",
...
function evolveIssue(game, issueItem) {
  ...
  if (age >= 3 && issueItem.escalationLevel < 1) {
    nextIssue = {
      ...
      message: `${issueItem.message} Ya lleva varios dÃ­as sin resolverse.`,
    };
  }
  if (age >= 7 && issueItem.escalationLevel < 2) {
    nextIssue = {
      ...
      message: `${issueItem.message} La situaciÃ³n empieza a tener consecuencias.`,
    };
